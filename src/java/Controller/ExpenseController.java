...
//    PurchaseSellDao PurchaseSellDaoObj = new PurchaseSellDaoImpl();
    ExpenseDao expDaoObj = new ExpenseDaoImpl();
...
//                            params.put("remark", request.getParameter("remark"));
                            resultJSONObject = expDaoObj.addExpenseMaterial(params);
                            response.sendRedirect("OtherExpense.jsp?result=" + resultJSONObject);
                        }
                        break;
//                        case "PurchaseFood": {
//                            HashMap<String, String> params = new HashMap<String, String>();
