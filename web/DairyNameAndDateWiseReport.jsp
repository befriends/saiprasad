<%-- 
    Document   : DairyNameAndDateWiseReport
    Created on : 22 Oct, 2016, 10:50:55 AM
    Author     : sai
--%>
...
<%!
    ...
    String dairyName = "",milkType="",remark="";
%>
<%
...
<html>
    <head>
        ...
        <title>Dairy Name Wise Report</title>
        <%
            ...
            if (jobj != null && jobj.has("success") && jobj.has("data")) {
                ...
                for (int i= 0; jarr.length() > i; i++ ){
                    dairyName = jarr.getJSONObject(i).optString("dairyid","");
    ...
    <body>
        ...
        <div style="font-size: 12px; font-weight: bold;text-align: center;">Dairy Name And Date Wise Report</div>
        <div style="text-align: left;font-size: 10px;">Customer Name : <%=dairyName%></div>
